...
{
    internal sealed class PatrolDefenseProviderResultV4AdmissionData
    {
    ...
    internal static class PatrolDefenseProviderResultV4Admission
    {
        ...
        private static void Reject(
            PatrolDefenseProviderResultV4AdmissionData data,
            string reason)
        {
            if (
                data != null &&
        ...
        internal static PatrolDefenseProviderResultV4AdmissionData
        ...
        private static PatrolDefenseProviderResultV4AdmissionData
            EvaluateInternal(
                PatrolDefenseAdvisoryRuntimeGate gate,
                PatrolDefenseProviderDispatchQueue dispatchQueue,
                string envelopeJson)
        {
            PatrolDefenseProviderResultV4AdmissionData data =
                new PatrolDefenseProviderResultV4AdmissionData();
            ...
            PatrolDefenseProviderResultV4AdmissionData data)
        {
            ...
            sb.Append("{");
            sb.Append(
                "\"schema\":\"BannerlordAI.PatrolDefenseProviderResultV4Admission.v1\"");
