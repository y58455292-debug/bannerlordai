...
{
    internal sealed class PatrolDefenseProviderResultV3AdmissionData
    {
    ...
    internal static class PatrolDefenseProviderResultV3Admission
    {
        ...
        private static void Reject(
            PatrolDefenseProviderResultV3AdmissionData data,
            string reason)
        {
            if (
                data != null &&
        ...
        internal static PatrolDefenseProviderResultV3AdmissionData
        ...
        private static PatrolDefenseProviderResultV3AdmissionData
            EvaluateInternal(
                PatrolDefenseAdvisoryRuntimeGate gate,
                PatrolDefenseProviderDispatchQueue dispatchQueue,
                string envelopeJson)
