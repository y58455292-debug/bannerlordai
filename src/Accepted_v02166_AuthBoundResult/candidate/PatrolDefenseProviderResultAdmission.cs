...
{
    internal sealed class PatrolDefenseProviderResultAdmissionData
    {
    ...
    internal static class PatrolDefenseProviderResultAdmission
    {
        internal const string ResultSchema =
            "BannerlordAI.PatrolDefenseProviderResult.v1";
        ...
        private static void Reject(
            PatrolDefenseProviderResultAdmissionData data,
            string reason)
        {
            if (
                data != null &&
        ...
        internal static PatrolDefenseProviderResultAdmissionData
            Evaluate(
        ...
        private static PatrolDefenseProviderResultAdmissionData
            EvaluateInternal(
                PatrolDefenseAdvisoryRuntimeGate gate,
                PatrolDefenseProviderDispatchQueue dispatchQueue,
