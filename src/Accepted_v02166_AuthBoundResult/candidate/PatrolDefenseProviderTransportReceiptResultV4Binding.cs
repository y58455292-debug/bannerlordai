...
{
    internal sealed class PatrolDefenseProviderTransportReceiptResultV4BindingData
    {
        ...
        internal List<string> RejectionReasons =
            new List<string>();
        internal PatrolDefenseProviderResultV4AdmissionData
            ProviderResultAdmission;
    }

    internal static class PatrolDefenseProviderTransportReceiptResultV4Binding
    {
        ...
        private static void Reject(
            PatrolDefenseProviderTransportReceiptResultV4BindingData data,
            string reason)
        {
            if (data != null &&
        ...
        internal static PatrolDefenseProviderTransportReceiptResultV4BindingData
            Evaluate(
                ...
                byte[] resultBytes)
        {
            ...
            data.ProviderResultAdmission =
                PatrolDefenseProviderResultV4Admission.EvaluateRequestBound(
                    gate,
                    queue,
                    resultJson);
            ...
            PatrolDefenseProviderTransportReceiptResultV4BindingData data)
        {
            ...
            sb.Append("{");
            sb.Append(
                "\"schema\":\"BannerlordAI.PatrolDefenseProviderTransportReceiptResultV4Binding.v1\"");
