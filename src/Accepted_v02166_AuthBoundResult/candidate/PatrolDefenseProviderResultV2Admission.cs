...
{
    internal sealed class PatrolDefenseProviderResultV2AdmissionData
    {
    ...
    internal static class PatrolDefenseProviderResultV2Admission
    {
        ...
        private static void Reject(
            PatrolDefenseProviderResultV2AdmissionData data,
            string reason)
        {
            if (
                data != null &&
        ...
        internal static PatrolDefenseProviderResultV2AdmissionData
        ...
        private static PatrolDefenseProviderResultV2AdmissionData
            EvaluateInternal(
                PatrolDefenseAdvisoryRuntimeGate gate,
                PatrolDefenseProviderDispatchQueue dispatchQueue,
                string envelopeJson)
