...
authorization = {
    ...
    "mode": "observe",
    "transportExecutionAuthorizationId": loop._authorization_id(fp, policy_id, 2),
    "requestFingerprint": fp,
    "executionPolicyId": policy_id,
    "attemptOrdinal": 2,
    "attemptCount": 2,
...
missing_policy = loop.send_loopback_v5(
...
bad_transport = loop.send_loopback_v5(
...
missing_auth = loop.send_loopback_v5(
    provider_json,
    provider_reg,
    transport_json,
    transport_reg,
...
bad_auth = loop.send_loopback_v5(
    provider_json,
    provider_reg,
    transport_json,
    transport_reg,
...
wrong_policy_auth = loop.send_loopback_v5(
    provider_json,
    provider_reg,
    transport_json,
    transport_reg,
...
tampered_auth_id = dict(authorization)
...
wrong_fp_auth = loop.send_loopback_v5(
    provider_json,
    provider_reg,
    transport_json,
    transport_reg,
...
bad_attempt_auth = loop.send_loopback_v5(
    provider_json,
    provider_reg,
    transport_json,
    transport_reg,
...
missing_timeout_out = loop.send_loopback_v5(
...
zero_timeout_out = loop.send_loopback_v5(
...
wrong_timeout_out = loop.send_loopback_v5(
