...
namespace BannerlordInspector
{
    ...
    public static class CampaignPhasePatches
    {
        ...
        public static void Apply(Harmony harmony)
        {
            ...
            // v0.30: observe TaleWorlds' public MobilePartyAIModel contract
            // directly so rear-security research can measure attack/avoid/
            // initiative decisions instead of inferring them from outcomes.
            InitiativeModelProbe.Apply(harmony);
        }
