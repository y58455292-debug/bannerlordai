...
## Local work warning
The local checkout was at `45c84325b911d91767d7188e06e0b491e0c165d0` when this task began and matched GitHub main at that checkpoint. This environment's portable Git lacks the `remote-https` helper, so it could not fetch the documentation commits made through the GitHub API; local main is now behind authoritative GitHub main. Do not start a foreground Git process while the live Bannerlord session is present. The L1 DLL is deployed locally with verified rollback at `D:\\BannerlordAIResearch\\Builds\\Rollback_Phase2D_L1_20260924_ClanAI`; its SHA-256 is recorded in the runtime result. The protected demo-gate save was not overwritten. The L1 DLL is deployed locally with verified rollback at `D:\BannerlordAIResearch\Builds\Rollback_Phase2D_L1_20260924_ClanAI`; its SHA-256 is recorded in the runtime result. The protected demo-gate save was not overwritten.
