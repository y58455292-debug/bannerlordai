...
TARGET_SAVE = SAVES / "ClanAI v020O BLACKBOARD CONSUME TEST.sav"
...
def main():
    ...
    validation = ROOT / "Longitudinal/LiveValidation" / ("ActorBlackboard_v020O_ConsumeAuto_" + stamp)
    ...
    manifest = {
        ...
        "modules": modules,
        "command": cmd,
        "stop_condition": "blackboardCaptures>=100, validations>=100, visual-war reads>0, weak-recovery reads>0, with zero blackboard/composer mismatches or failures, or timeout",
